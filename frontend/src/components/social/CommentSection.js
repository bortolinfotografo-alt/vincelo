...
// Secao de comentarios de um post
              ...
              <div key={c.id} className="flex items-start gap-2">
                ...
                <div className="flex-1">
                  <div className="bg-gray-100 rounded-lg px-3 py-2 dark:bg-gray-800">
                    <Link href={`/profile/${c.author.id}`} className="text-xs font-semibold text-gray-800 hover:underline dark:text-gray-200">
                      {c.author.name}
                    </Link>
                    <p className="text-sm text-gray-600 mt-0.5 dark:text-gray-300">{c.content}</p>
                  </div>
          ...
          {user && (
            <form onSubmit={handleSubmit} className="flex items-center gap-2 mt-2">
              ...
              <button
                ...
                className="text-primary-500 hover:text-primary-400 disabled:opacity-30"
              >
                <Send size={16} />
              </button>
            </form>
